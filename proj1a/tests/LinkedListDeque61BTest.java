...
public class LinkedListDeque61BTest {
    ...
    public void GetTest(){
        ...
        assertThat(lld1.get(-1)).isEqualTo(null);
        Integer num1 = 1;
        assertThat(lld1.get(1)).isEqualTo(num1);
        assertThat(lld1.get(2)).isEqualTo(null);
        lld1.addFirst(-1); //[-1]
        lld1.addFirst(-2); //[-1, -2]
        Integer num2 = -1;
        assertThat(lld1.get(1)).isEqualTo(num2);
    ...
    public void GetRecursiveTest(){
        ...
        assertThat(lld1.getRecursive(-1)).isEqualTo(null);
        Integer num1 = 1;
        assertThat(lld1.getRecursive(1)).isEqualTo(num1);
        assertThat(lld1.getRecursive(2)).isEqualTo(null);
        lld1.addFirst(-1); //[-1]
        lld1.addFirst(-2); //[-1, -2]
        Integer num2 = -1;
        assertThat(lld1.getRecursive(1)).isEqualTo(num2);
    ...
    public void removeFirstAndremoveLastTest(){
        ...
        lld1.removeFirst();   // [0, 2]
        lld1.addFirst(-2); // [-2, 0, 2]

        assertThat(lld1.toList()).containsExactly(-2, 0, 2).inOrder();
    }
}